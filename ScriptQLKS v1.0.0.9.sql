...
GO
DBCC CHECKIDENT(N'[dbo].[Customers]', RESEED, 21)
GO
...
GO
GO
INSERT INTO [dbo].[Customers] ([CusID], [CusName], [CusTypeID], [CusIDCard], [CusAddress], [RoomID], [BookRoom]) VALUES (N'20', N'a', N'13', N'243656579', N'569fgbfb', N'52', N'1')
GO
GO
INSERT INTO [dbo].[Customers] ([CusID], [CusName], [CusTypeID], [CusIDCard], [CusAddress], [RoomID], [BookRoom]) VALUES (N'21', N'a', N'13', N'12', N'a', N'0', N'1')
GO
GO
...
GO
GO
INSERT INTO [dbo].[Users] ([f_ID], [f_UserName], [f_Password], [f_Name], [f_Permission]) VALUES (N'7', N'a1', N'81DC9BDB52D04DC2036DBD8313ED055', N'a1', N'0')
GO
GO
...
-- ----------------------------
ALTER TABLE [dbo].[OrderDetails] ADD PRIMARY KEY ([OrderID])
GO
